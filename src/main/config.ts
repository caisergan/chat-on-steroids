...
const configSchema = z.object({
  ...
  ui: z.object({
    ...
    cliControl: z.boolean().optional().default(false),
...
export function defaultConfig(platform: NodeJS.Platform = process.platform, release?: string): Config {
  return {
    ...
    ui: { minimizeToTray: true, autoConnect: false, startAtLogin: false, privacyScreenshots: false, theme: 'dark', autoRefreshPlugins: false, cliControl: false, backgroundChats: true, browserBridgePort: 'auto', autoContinue: true },
